 ...
 * present in this system test. Pretend as if you are a legitimate user that is
 * manipulating data on a production system. Destroy any data that would
 * prevent a subsequent system test run from passing.
 */
