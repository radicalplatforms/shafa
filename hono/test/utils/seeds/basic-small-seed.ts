...
export default async function (
  db_name: string,
  db_port: number
): Promise<[ItemFactory[], OutfitFactory[], ItemToOutfitFactory[], TagFactory[], TagToOutfitFactory[], TagToItemFactory[]]> {
  ...
  return [items, outfits, items_to_outfits, tags, tags_to_outfits, tags_to_items]
}
